...
class WickerApiTestCase(APITestCase):
    def setUp(self):
        ...
        self.wicker_2 = Wicker.objects.create(name='Test wicker 2', price=2815, author_name='Author 1')
        self.wicker_3 = Wicker.objects.create(name='Test wicker 3', price=2815, author_name='Author 2')
